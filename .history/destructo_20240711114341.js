...
openMysteriousDoor(doorCode); // Using the doorCode object, which does not have middle
openMysteriousDoor({ upper: "Beta" }); // Providing only the upper value
openMysteriousDoor({ upper: "Beta", middle: "Eagle" }); // Providing upper and middle values
openMysteriousDoor({ upper: "Beta", middle: "Eagle", lower: "Zeta" }); // Providing all values
openMysteriousDoor(); // No arguments, using all default values
