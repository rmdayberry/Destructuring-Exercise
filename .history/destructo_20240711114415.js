...
openDoor(doorCode); // Using the doorCode object, which does not have middle
openDoor({ upper: "Beta" }); // Providing only the upper value
openDoor({ upper: "Beta", middle: "Eagle" }); // Providing upper and middle values
openDoor({ upper: "Beta", middle: "Eagle", lower: "Zeta" }); // Providing all values
openDoor(); // No arguments, using all default values
